...
@section('page_content')
    <section class="sec-1">
        <div class="sec-inner">
            <h1>Stephmond Solutions <br>  Commitment for Outstanding Services</h1>
            <div class="about-wrapper">
                <div class="about">
                    <p>Our team members are not just IT professionals but have good communication skills with people, which will help dissolve your needs and requirements. Our company takes care of every minute details our client communicates to us during the process of developing the project. As an IT Solution Provider, we are dedicated to bringing excellent IT Solutions.</p>
                    <br><br> 
                    <p>We investigate your business challenges!</p>
                    <p>We offer solutions tailored to suit you.</p>
                </div>
                <div class="about">
