...
<body>
        ...
        <div class="header-top">
            ...
            <div>
                <ul>
                    ...
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M464 64C490.5 64 512 85.49 512 112C512 127.1 504.9 141.3 492.8 150.4L275.2 313.6C263.8 322.1 248.2 322.1 236.8 313.6L19.2 150.4C7.113 141.3 0 127.1 0 112C0 85.49 21.49 64 48 64H464zM217.6 339.2C240.4 356.3 271.6 356.3 294.4 339.2L512 176V384C512 419.3 483.3 448 448 448H64C28.65 448 0 419.3 0 384V176L217.6 339.2z"/></svg></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="header">
            <nav>
                ...
                <div>
                    ...
                    <div class="cart-items-total">0</div>
                </div>
            </nav>
            <nav>
                <div> 
    ...
    <div class="nav-sm-screen">
        <div class="nav-sm-screen-inner">
            <div class="header">
                <img src="/images/logo.png" alt=""><p>X</p>
            </div>
            <div class="inner">
    ...
    <p>&copy; Copyright 2022 | Stephmond Solutions SYSTEMS LIMITED | All Rights Reserved.</p>

    <script>

        const NavSmScreen = document.querySelector('.nav-sm-screen');
        const NavToggleIcon = document.querySelector('header .header nav div h1 img');
        const NavSmScreenToggleIconX = document.querySelector('.nav-sm-screen div .header p');

        NavToggleIcon.addEventListener('click', () => {
            NavSmScreen.classList.toggle('toggle');
        });

        NavSmScreenToggleIconX.addEventListener('click', () => {
